 ...
 *
 *	@package	Ofcold\Presentable\Presenter
 */
abstract class Presenter implements \ArrayAccess
{
	...
	/**
	 *	The decorator instance so we can nest presenters. Underscores here to avoid conflicts if a presenter or object has
	 *	"decorator" as a variable.
	 *
	 *	@var		\Ofcold\Presentable\Decorator
	 */
	protected static $__decorator = null;
	...
	{
		return static::$__decorator ?: static::$__decorator = new Decorator();
	}

	/**
	 *	This is so you can extend the decorator and inject it into the presenter at the class level so the new decorator
	 *	will be used for nested presenters. Method name should be "setDecorator" however like above I want to make
	 *	conflicts less likely.
	 *
	 *	@param		\Ofcold\Presentable\Decorator
	 */
	 ...
	 *	@return		string|null
	 */
	protected function getPresenterMethodFromVariable(string $variable)
	{
		$method = 'present' . str_replace(
			' ',
			'',
			ucwords(
				str_replace(
